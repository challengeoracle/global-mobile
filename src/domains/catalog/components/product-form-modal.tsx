                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    <View className="gap-4">
                        ...
                        <View>
                            ...
                            <TextInput value={name} onChangeText={setName} maxLength={PRODUCT_NAME_MAX_LENGTH} placeholder="Ex: Carrinho de brinquedo" placeholderTextColor={placeholderColor} style={{ color: inputColor }} className="h-14 rounded-2xl border border-border bg-card px-4 text-base" />
                        </View>
