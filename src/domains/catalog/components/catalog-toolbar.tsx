...
function syncText(isConnected: boolean, pendingCount: number) {
    ...
    if (!isConnected) return "Sem internet";
...
export function CatalogToolbar({
    ...
    const showSellerStatus = mode === "seller";
    ...
    return (
        <View className="mb-5 gap-3">
            ...
            <BottomSheetModal visible={categoryModalVisible} eyebrow="Filtro" title="Categoria" onClose={() => setCategoryModalVisible(false)} maxHeightClassName="max-h-[80%]">
