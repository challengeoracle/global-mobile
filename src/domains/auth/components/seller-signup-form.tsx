...
export function SellerSignupForm({ form, onSubmit, serverError }: SellerSignupFormProps) {
    return (
        <View className="gap-5">
            ...
            <FormInput control={form.control} name="storeName" label="Nome da loja" placeholder="Minha loja" maxLength={120} />

            <FormInput control={form.control} name="storeCategory" label="Categoria" placeholder="Mercado" maxLength={100} />
