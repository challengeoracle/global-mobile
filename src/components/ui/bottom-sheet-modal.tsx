    ...
    return (
        <Modal visible={mounted} transparent animationType="none" onRequestClose={closeAnimated}>
            <View className="flex-1 justify-end">
                ...
                {/* sheet */}
                <Animated.View {...panResponder.panHandlers} style={{ transform: [{ translateY }] }} className={`${maxHeightClassName} rounded-t-[32px] border-t border-x border-border bg-background px-6 pb-8 pt-4`}>
                    {/* Alça superior para arraste */}
                    ...
                    <View className="mb-6 flex-row items-center justify-between gap-4">
                        ...
                        <Pressable onPress={closeAnimated} className="h-11 w-11 items-center justify-center rounded-2xl bg-muted">
                    ...
                    <View className="absolute left-0 right-0 h-64 -bottom-64 bg-background border-x border-border" />
                </Animated.View>
            </View>
        </Modal>
    );
