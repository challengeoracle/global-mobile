    ...
    return (
        <ScrollView className="flex-1 bg-background" showsVerticalScrollIndicator={false}>
            <View className="px-6 pb-10 pt-14">
                ...
                <View className="mt-6">{user?.role === "SELLER" ? <SellerHome user={user} networkInfo={networkInfo} offlineStatus={offlineStatus} /> : <CustomerHome user={user} networkInfo={networkInfo} offlineStatus={offlineStatus} />}</View>
            </View>
        </ScrollView>
    );
}
